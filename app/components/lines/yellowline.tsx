...
const Yellowline: React.FC<yellowProps> = ({ setAbout }) => {
    return (
        <div className="relative">
            <div className="bg-yellow h-3 md:h-6 w-[calc(100%-45px)] md:w-[calc(100%-50px-580px)] absolute top-[234px] md:top-[369px] left-[4px] md:left-[282px] rounded-[30px] sib"></div>
            <div className="bg-yellow h-[85px] md:h-32 w-3 md:w-6 absolute top-[161px] md:top-[265px] left-[4px] md:left-[282px] rounded-[30px] sitl">
            ...
            <div className="bg-yellow h-[70px] md:h-[370px] w-3 md:w-6 absolute top-[184px] md:top-[72px] left-[calc(100%-30px)] md:left-[calc(100%-50px-580px+382px)] rotate-45 rounded-[30px] sitr"></div>
        </div>
    );
}
