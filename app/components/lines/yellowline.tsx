...
const Yellowline: React.FC<yellowProps> = ({ setAbout }) => {
    return (
        <div className="relative">
            <div className="bg-yellow h-3 md:h-6 w-[calc(100%-55px)] md:w-[calc(100%-50px-580px)] absolute top-[234px] md:top-[369px] left-[14px] md:left-[282px] tl-tr-br-bl sib"></div>
            <div className="bg-yellow h-[85px] md:h-32 w-3 md:w-6 absolute top-[161px] md:top-[265px] left-[14px] md:left-[282px] tl-tr-br-bl sitl">
