    ...
    return (
        <div className="relative">
            ...
            <div className="bg-red h-[115px] md:h-[247px] w-3 md:w-6 absolute top-[118px] md:top-[122px] left-[calc(100%-64px)] md:left-[454px] lg:left-[calc(100%-50px-760px+290px)] tl-tr-br-bl sir">
                <button onClick={() => {setProject(true)}} type="button" className="open-btn relative left-[1px] md:left-[2px] w-[10px] md:w-5 h-[10px] md:h-5 bg-darkgrey border-[1px] md:border-2 border-lightgrey rounded-full -top-[3px] lg:top-[2px]">
