...
const Blueline: React.FC<blueProps> = ({ setContact }) => {
    return (
        <div className="relative">
            ...
            <div className="bg-blue w-6 h-[159px] absolute top-[417px] left-[calc(100%-500px)] lg:left-[473px] tl-tr-br-bl sil"></div>
            <div className="bg-blue h-6 w-[calc(100%-585px)] lg:w-[390px] absolute top-[552px] left-[105px] tl-tr-br-bl sib"></div>
