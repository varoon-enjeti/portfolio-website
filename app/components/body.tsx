	...
	return (
		<div className="w-[calc(100%-40px)] h-[calc(100%-40px)] md:w-[calc(100%-50px)] md:h-[calc(100%-50px)]">
			...
			<div className="flex h-full w-full justify-between items-end">
				<div className="font-sans font-light text-[14px] md:text-[22px] tracking-[-0.04em] text-darkgrey pl-[7px] data">
					{width} x {height}
				</div>
				<div className="font-sans font-light text-[14px] md:text-[22px] tracking-[-0.04em] text-darkgrey mr-2 data">
					{formatTime(time)}
				</div>
			</div>
			<div className="">
				...
				<CSSTransition
					...
					classNames="transition"
					unmountOnExit
					onEnter={() => setSkills(true)}
					onExited={() => setSkills(false)}
				>
