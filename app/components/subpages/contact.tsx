        ...
        <div className="w-full h-[calc(100%-49px)] md:h-[calc(100%-108px)] bg-[#DEDEDE] absolute top-[49px] md:top-[108px] left-0 z-10 border-[3px] md:border-4 border-darkgrey rounded-t-[15px]">
            <div className="flex h-full w-full">
                <div className="flex h-10 w-full justify-between mx-[6px] my-[6px]">
                    <button onClick={() => {setContact(false)}} className="w-[40px] 3xl:w-[50px] h-[40px] 3xl:h-[50px] bg-blue rounded-[13px] close">
                    ...
                    <div className="font-sans text-blue font-bold track tracking-[-0.04em] text-[45px] 3xl:text-[56px] subptext mr-1 3xl:mt-1">Contact</div>
