		...
		<div className="h-full w-full flex flex-col">
			...
			<div className="h-full w-full flex justify-center items-center gap-6 3xl:gap-10">
				<div className="flex flex-col h-full gap-6 3xl:gap-10 items-center justify-center">
					<div className="w-[512px] 3xl:w-[640px] h-[299px] 3xl:h-[363px] border-4 bg-white border-darkgrey rounded-[15px] box flex flex-col">
						<div className="w-full h-[100px] 3xl:h-[125px] flex mx-2 mt-2">
							<Image
								...
								width={500}
								height={500}
								className="h-[99px] w-[99px] 3xl:h-[118px] 3xl:w-[118px] rounded-[15px] border-darkgrey border-[3px] exp"
							/>
						...
						<div className="font-sans font-normal text-darkgrey tracking-[-0.04em] text-[20px] 3xl:text-[25px] ml-2 text-wrap 3xl:mt-[-2px]">{`on the intersection of software and hardware, and I'm hoping to create code that interacts with the physical world. I am also absolutely fascinated with transit maps, so I used them`}</div>
						<div className="w-full h-[100px] 3xl:h-[125px] flex">
							...
							<Image
								...
								width={500}
								height={500}
								className="h-[99px] w-[99px] 3xl:h-[118px] 3xl:w-[118px] rounded-[15px] border-darkgrey border-[3px] mt-[1px] 3xl:mt-[5px] mr-2 exp"
							/>
						</div>
					</div>
				...
				<div className="flex h-full items-center justify-center">
					<div className="w-[504px] 3xl:w-[630px] h-[502px] 3xl:h-[628px] border-4 bg-white border-darkgrey rounded-[15px] box">
