	...
	return (
		<div className="w-1/2 absolute flex flex-col items-start md:pl-[7px] gap-0 md:gap-[11px] header">
			<button
				...
				className="font-sans font-bold w-[210px] md:w-[600px] h-[38px] md:h-[93px] text-[35px] md:text-[100px] tracking-[-0.04em] text-darkgrey relative z-20 name text-left"
			>
				Varoon Enjeti
			</button>
			<div className="h-[48px] md:h-[98px] flex gap-3 md:gap-5">
				...
				<div className="flex flex-col justify-center -mt-[10px] md:mt-0 md:gap-3">
					<div className="font-sans font-bold h-[24px] md:h-[36px] text-[21px] md:text-[43px] tracking-[-0.04em] text-darkgrey">
						Transit Map
					</div>
					<div className="font-sans font-bold h-[24px] md:h-[36px] text-[21px] md:text-[43px] tracking-[-0.04em] text-darkgrey">
						Portfolio
